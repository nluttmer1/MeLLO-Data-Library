...
Full_marker = readtable('Subject 4 - Trajectories.csv', 'PreserveVariableNames', true);
...
save('Full_marker_processed2.mat', 'Full_marker_changed2');
...
Full_marker_processed = load("Full_marker_processed2_BAUM.mat");
...
Marker1_RToe_x = Marker1(:,231)/1000; % WheelBarrow 231 - Gait 198
Marker1_RToe_y = Marker1(:,232)/1000; % WheelBarrow 232 - Gait 199
Marker1_RToe_z = Marker1(:,233)/1000; % WheelBarrow 233 - Gait 200

Marker1_RHeel_x = Marker1(:,228)/1000; % WheelBarrow 228 - Gait 195
Marker1_RHeel_y = Marker1(:,229)/1000; % WheelBarrow 229 - Gait 196
Marker1_RHeel_z = Marker1(:,230)/1000; % WheelBarrow 230 - Gait 197

Marker1_RAnkle_x = Marker1(:,222)/1000; % WheelBarrow 222 - Gait 189
Marker1_RAnkle_y = Marker1(:,223)/1000; % WheelBarrow 223 - Gait 190
Marker1_RAnkle_z = Marker1(:,224)/1000; % WheelBarrow 224 - Gait 191

Marker1_LToe_x = Marker1(:,183)/1000; % WheelBarrow 183 - Gait 183
Marker1_LToe_y = Marker1(:,184)/1000; % WheelBarrow 184 - Gait 184
Marker1_LToe_z = Marker1(:,185)/1000; % WheelBarrow 185 - Gait 185

Marker1_LHeel_x = Marker1(:,180)/1000; % WheelBarrow 180 - Gait 147
Marker1_LHeel_y = Marker1(:,181)/1000; % WheelBarrow 181 - Gait 148
Marker1_LHeel_z = Marker1(:,182)/1000; % WheelBarrow 182 - Gait 149

Marker1_LAnkle_x = Marker1(:,174)/1000; % WheelBarrow 174 - Gait 141
Marker1_LAnkle_y = Marker1(:,175)/1000; % WheelBarrow 175 - Gait 142
Marker1_LAnkle_z = Marker1(:,176)/1000; % WheelBarrow 176 - Gait 143

RHeel_Start_Index1 = 2934;
RHeel_End_Index1 = 3061;
RHeel_Start_Index2 = 5843;
RHeel_End_Index2 = 5972;
RHeel_Start_Index3 = 10833;
RHeel_End_Index3 = 10958;
RHeel_Start_Index4 = 12353;
RHeel_End_Index4 = 12478;
RHeel_Start_Index5 = 15419;
RHeel_End_Index5 = 15541;
RHeel_Start_Index6 = 17454;
RHeel_End_Index6 = 17576;
RHeel_Start_Index7 = 20144;
RHeel_End_Index7 = 20271;
RHeel_Start_Index8 = 22299;
RHeel_End_Index8 = 22416;
RHeel_Start_Index9 = 37060;
RHeel_End_Index9 = 37184;
RHeel_Start_Index10 = 40197;
RHeel_End_Index10 = 40323;
...
LHeel_Start_Index1 = 2865;
LHeel_End_Index1 = 3000;
LHeel_Start_Index2 = 5783;
LHeel_End_Index2 = 5906;
LHeel_Start_Index3 = 10898;
LHeel_End_Index3 = 11017;
LHeel_Start_Index4 = 12286;
LHeel_End_Index4 = 12416;
LHeel_Start_Index5 = 15480;
LHeel_End_Index5 = 15602;
LHeel_Start_Index6 = 17514;
LHeel_End_Index6 = 17639;
LHeel_Start_Index7 = 20207;
LHeel_End_Index7 = 20330;
LHeel_Start_Index8 = 22357;
LHeel_End_Index8 = 22475;
LHeel_Start_Index9 = 36995;
LHeel_End_Index9 = 37123;
LHeel_Start_Index10 = 40132;
LHeel_End_Index10 = 40261;
